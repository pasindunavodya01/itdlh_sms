...
export default function ManagePayments() {
  ...
  const fetchStudentCourses = async (admissionNumber) => {
    try {
      const res = await axios.get(`https://itdlhsms-production.up.railway.app/api/students/courses/${admissionNumber}`);
  ...
  const fetchCurrentPayment = useCallback(async () => {
    ...
    try {
      const response = await axios.get(`https://itdlhsms-production.up.railway.app/api/payments/current/${selectedStudent}/${selectedCourse}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://itdlhsms-production.up.railway.app/api/payments/add-for-student', {
