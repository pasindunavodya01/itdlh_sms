...
export default function ViewStudents() {
  ...
  const fetchStudentsWithNotes = async () => {
    try {
      const response = await axios.get('https://itdlhsms-production.up.railway.app/api/students/with-notes');
  ...
  const saveNote = async () => {
    try {
      await axios.put(
        `https://itdlhsms-production.up.railway.app/api/students/${selectedStudent.student.uid}/note`,
  ...
  const fetchAllStudents = async () => {
    try {
      const response = await axios.get('https://itdlhsms-production.up.railway.app/api/students/all');
  ...
  const handleStudentClick = async (student) => {
    try {
      ...
      const response = await axios.get(`https://itdlhsms-production.up.railway.app/api/students/profile/${student.uid}`);
                ...
                {isEditing ? (
                  <form
                    onSubmit={async (e) => {
                      ...
                      try {
                        await axios.put(
                          `https://itdlhsms-production.up.railway.app/api/students/update/${selectedStudent.student.uid}`,
                          editForm
                        );
          ...
          >
            ...
            <select
              ...
              onChange={async (e) => {
                ...
                await axios.put(
                  `https://itdlhsms-production.up.railway.app/api/students/classes/${selectedStudent.student.uid}/${course.course_id}`,
                  { class_id: newClassId }
                );
                alert("Class updated!");
