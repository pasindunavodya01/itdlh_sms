...
export default function AdminAnnouncements() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await axios.put(`https://itdlhsms-production.up.railway.app/api/announcements/${editingId}`, data);
        setStatusMessage('Announcement updated successfully');
      } else {
        await axios.post('https://itdlhsms-production.up.railway.app/api/announcements', data);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this announcement?')) {
      try {
        await axios.delete(`https://itdlhsms-production.up.railway.app/api/announcements/${id}`);
