...
useEffect(() => {
  if (formData.course_id) {
    ...
    axios.get(`https://itdlhsms-production.up.railway.app/api/courses/${formData.course_id}/classes`)
...
const handleSubmit = async e => {
  ...
  try {
    ...
    const res = await axios.post('https://itdlhsms-production.up.railway.app/api/attendance/session', payload);
